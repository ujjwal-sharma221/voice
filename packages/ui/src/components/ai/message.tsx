...
export const AIMessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:border-transparent group-[.is-user]:bg-gradient-to-b group-[.is-user]:from-primary group-[.is-user]:to-[#7F55B1] group-[.is-user]:text-primary-foreground",
      className,
    )}
    {...props}
  >
